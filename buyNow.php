<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        $type=$_POST['type'];
         ...
         $sql = "INSERT INTO transaction (bid, pid, name, city, mobile, email, pincode, addr, quantity, type, date)
                VALUES ('$bid', '$pid', '$name', '$city', '$mobile', '$email', '$pincode', '$addr', '$quantity', '$type', '$today')";
                ...
                <form method="post" action="buyNow.php?pid=<?= $pid; ?>" style="border: 1px solid black; padding: 15px;">
                    ...
                    <div class="row uniform">
                        <div class="4u 12u$(xsmall)">
                            <input type="text" name="pincode" id="pincode" value="Near Point" placeholder="" required/>
                        </div>
                        <div class="8u 12u$(xsmall)">
                            <input type="text" name="addr" id="addr" value="" placeholder="District" style="width:80%" required/>
                        </div>
                    </div>
                    <br />
                    <p>
