...
<?php
					...
					$powner = $row['powner'];
					$sql = "SELECT * FROM fproduct WHERE powner = '$powner'";
					$result = mysqli_query($conn, $sql);
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-12 col-sm-6">
									...
									<p style="font: 30px Times new roman;">Product Owner : <?= $frow['powner']; ?></p>
						...
						<div class="12u$">
                            <center>
                                <div class="row uniform">
                                    ...
                                    <div class="6u 12u$(large)">
                                        <a href="fbuyNow.php?pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;">Buy Now</a>
                                    </div>
                                </div>
                            </center>
                        </div>
