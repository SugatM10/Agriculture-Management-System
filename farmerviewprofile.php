...
<!DOCTYPE html>
        ...
        <section id="one" class="wrapper style1 align">
            <div class="inner">
                ...
                <header>
                    <center>
                    <span><img src="<?php echo 'images/profileImages/'.$_SESSION['picName'].'?'.mt_rand(); ?>" class="image-circle" class="img-responsive" width="20%" height="20%"></span>
                    <br>
                            ...
                            <center>
                                <div class="row uniform">
                                    ...
                                    <div class="3u 12u$(large)">
                                        <a href="farmerprofileedit.php" class="btn btn-danger" style="text-decoration: none;">Edit Profile</a>
                                    </div>
                                     <div class="3u 12u$(large)">
                                        <a href="fprice.php" class="btn btn-danger" style="text-decoration: none;">Today's Rate</a>
                                    </div>
                                    <div class="3u 12u$(xsmall)">
            							<a href="applyform.php" class="btn btn-danger" style="text-decoration: none;">Apply for Sale</a>
            						</div>
                                    <div class="3u 12u$(large)">
