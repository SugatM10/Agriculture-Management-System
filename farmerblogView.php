			...
			<header id="header">
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="Login/logout.php"><span class="glyphicon glyphicon-home"></span> Logout</a></li>
				...
				<div class="inner">
					...
					<div class="row uniform">
						...
						<div class="3u 12u$(small)">
							<a href="farmerblogWrite.php" class="button special fit"><span class="glyphicon glyphicon-pencil"></span> Write a Blog</a>
						</div>
					</div>
					<br />
					<?php
