<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
		...
		$sql = "INSERT INTO fproduct (product, pcat, pinfo, price, powner, date)
			   VALUES ('$productName', '$productType', '$productInfo', '$productPrice', '$powner', '$today')";
		...
		<!DOCTYPE html>
			<header id="header">
				...
				<nav id="nav">
					...
					<li><a href="Login/logout.php"><span class="<?php echo $logo; ?>"></span>Logout</a></li>
					</ul>
				</nav>
			</header>
			...
			<section id="one" class="wrapper style1 align-center">
				...
				<div class="row">
					  ...
					  <div class="col-sm-6">
						...
						<input type="text" name="powner" id="powner" value="" placeholder="Product Owner" style="background-color:white;color: black;" />
					  </div>
				</div>
				<br>
				<div>
