                            ...
                            <center>
                                ...
                                <div class="row uniform">
                                    <div class="3u 12u$(large)">
                                        <a href="buyerlogin.php" class="btn btn-danger" style="text-decoration: none;">Buyer Login</a>
                                    </div>
                                    <div class="3u 12u$(large)">
                                        <a href="farmerlogin.php" class="btn btn-danger" style="text-decoration: none;">Farmer Login</a>
                                    </div>
                                    <div class="3u 12u$(large)">
                                        <a href="index.php" class="btn btn-danger" style="text-decoration: none;">Back to Home</a>
                                    </div>
                                  <div class="3u 12u$(large)">
                                        <a href="register.php" class="btn btn-danger" style="text-decoration: none;">Back to Register</a>
                                    </div>
                                </div>
                            </center>
                        </div>
