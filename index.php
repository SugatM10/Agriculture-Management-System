				...
				<center>
					<div class="row uniform">
						<div class="6u 12u$(xsmall)">
							<a href="logins.php"><button class="button fit" style="width:auto">LOGIN</button></a>
						</div>

						<div class="6u 12u$(xsmall)">
							<div class="6u 12u$(xsmall)">
							<a href="register.php"><button class="button fit" style="width:auto">REGISTER</button></a>
						</div>
					</div>
				</center>
